...
public class TokenInfoDictionaryBuilder {
  ...
  public static void main(String[] args) throws IOException {
    ...
    TokenInfoDictionaryWriter writer = builder.build("/Users/gyun/project/lucene-analyzer-nori/mecab-ko-dic-2.0.3-20170922");
    writer.write("/Users/gyun/project/lucene-analyzer-nori/dict");
  }
  public TokenInfoDictionaryWriter buildDictionary(List<File> csvFiles) throws IOException {
    ...
    Builder fstBuilder = new Builder(FST.INPUT_TYPE.BYTE2, 0, 0, true, true, Integer.MAX_VALUE, fstOutput,true, 100f,true, 15);
